const render = {
  load: ['env','streamListener','dispatcher','tagger', 'db', 'evt'],
  renders: [],
  streams: [],
      ...
      if(err == null) {
        this.load.dispatcher.dispatch({
          ...
          if(this.load.env.debug) {
            if(err) {
              console.log('ERROR IN DISPATCH RENDER CONFIRMATION:');
              console.log(err);
            } else {
        ...
        this.load.dispatcher.dispatch({
          ...
          if(this.load.env.debug) {
            if(err) {
              console.log('ERROR IN DISPATCH RENDER FAILURE:');
              console.log(err);
            } else {
              console.log('RENDERIZED FAILURE:');
              console.log(evt);
            }
          }
        });
